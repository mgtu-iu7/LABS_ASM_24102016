...
JNC PERENOS		;проверка флага переноса (бит переноса) если равен 1 то загружаю его в регистр E иначе перепрыгиваю через три команды
PERENOS: MVI E,1;Загрузка в аккумулятор бит переноса 0001h (1)
NOP;
NOP;				
